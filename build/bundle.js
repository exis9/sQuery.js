	...
	function create_fragment$2(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(h22, file$1, 224, 3, 9968);
				add_location(br28, file$1, 226, 69, 10088);
				attr_dev(div90, "class", "cPreDesc");
				add_location(div90, file$1, 225, 3, 9996);
				attr_dev(div91, "class", "cBack");
				add_location(div91, file$1, 231, 5, 10202);
				attr_dev(div92, "class", "cDesc");
				add_location(div92, file$1, 230, 4, 10177);
				attr_dev(div93, "class", "cBack");
				add_location(div93, file$1, 237, 5, 10332);
				attr_dev(div94, "class", "cDesc");
				add_location(div94, file$1, 236, 4, 10307);
				add_location(div95, file$1, 229, 3, 10167);
				attr_dev(doc2, "name", "Use_with_jQuery");
				add_location(doc2, file$1, 223, 2, 9936);
				add_location(h23, file$1, 245, 3, 10509);
				attr_dev(a8, "href", "https://nodejs.org/");
				attr_dev(a8, "target", "_blank");
				add_location(a8, file$1, 247, 12, 10571);
				add_location(br29, file$1, 247, 95, 10654);
				attr_dev(a9, "href", "https://create-react-app.dev/docs/getting-started");
				attr_dev(a9, "target", "_blank");
				add_location(a9, file$1, 248, 38, 10697);
				attr_dev(div96, "class", "cPreDesc");
				add_location(div96, file$1, 246, 3, 10536);
				add_location(br30, file$1, 252, 37, 10894);
				add_location(br31, file$1, 253, 12, 10911);
				add_location(br32, file$1, 254, 14, 10930);
				attr_dev(div97, "class", "cSh notranslate");
				add_location(div97, file$1, 251, 4, 10827);
				attr_dev(a10, "href", "https://www.typescriptlang.org/");
				attr_dev(a10, "target", "_blank");
				add_location(a10, file$1, 256, 31, 10977);
				add_location(br33, file$1, 258, 59, 11160);
				add_location(br34, file$1, 259, 12, 11177);
				add_location(br35, file$1, 260, 14, 11196);
				attr_dev(div98, "class", "cSh notranslate");
				add_location(div98, file$1, 257, 4, 11071);
				add_location(hr1, file$1, 263, 4, 11217);
				attr_dev(div99, "class", "cSh notranslate");
				add_location(div99, file$1, 266, 4, 11265);
				attr_dev(div100, "class", "cSh notranslate");
				add_location(div100, file$1, 271, 4, 11362);
				add_location(div101, file$1, 250, 3, 10817);
				attr_dev(doc3, "name", "Use_with_React");
				add_location(doc3, file$1, 244, 2, 10478);
				add_location(h24, file$1, 278, 3, 11473);
				attr_dev(a11, "href", "https://vuejs.org/guide/quick-start.html");
				attr_dev(a11, "target", "_blank");
				add_location(a11, file$1, 280, 18, 11542);
				add_location(br36, file$1, 280, 125, 11649);
				attr_dev(div102, "class", "cPreDesc");
				add_location(div102, file$1, 279, 3, 11501);
				attr_dev(doc4, "name", "Use_with_Vue");
				add_location(doc4, file$1, 277, 2, 11444);
				add_location(h25, file$1, 286, 3, 11743);
				attr_dev(a12, "href", "https://vuejs.org/guide/quick-start.html");
				attr_dev(a12, "target", "_blank");
				add_location(a12, file$1, 288, 18, 11812);
				add_location(br37, file$1, 288, 125, 11919);
				attr_dev(div103, "class", "cPreDesc");
				add_location(div103, file$1, 287, 3, 11771);
				attr_dev(doc5, "name", "Use_with_Svelte");
				add_location(doc5, file$1, 285, 2, 11711);
				add_location(h26, file$1, 294, 3, 12014);
				attr_dev(a13, "href", "https://vuejs.org/guide/quick-start.html");
				attr_dev(a13, "target", "_blank");
				add_location(a13, file$1, 296, 18, 12084);
				add_location(br38, file$1, 296, 125, 12191);
				attr_dev(div104, "class", "cPreDesc");
				add_location(div104, file$1, 295, 3, 12043);
				attr_dev(doc6, "name", "Use_with_SolidJS");
				add_location(doc6, file$1, 293, 2, 11981);
				add_location(h27, file$1, 302, 3, 12286);
				attr_dev(a14, "href", "https://vuejs.org/guide/quick-start.html");
				attr_dev(a14, "target", "_blank");
				add_location(a14, file$1, 304, 18, 12356);
				add_location(br39, file$1, 304, 125, 12463);
				attr_dev(div105, "class", "cPreDesc");
				add_location(div105, file$1, 303, 3, 12315);
				attr_dev(doc7, "name", "Use_with_Angular");
				add_location(doc7, file$1, 301, 2, 12253);
				attr_dev(h28, "class", "notranslate");
				add_location(h28, file$1, 312, 3, 12554);
				attr_dev(span3, "class", "cJQVer");
				attr_dev(span3, "v", "filter");
				add_location(span3, file$1, 315, 4, 12736);
				attr_dev(div106, "class", "cPreDesc");
				add_location(div106, file$1, 313, 3, 12599);
				attr_dev(div107, "class", "cBack");
				add_location(div107, file$1, 319, 5, 12824);
				attr_dev(div108, "class", "cDesc");
				add_location(div108, file$1, 318, 4, 12799);
				add_location(div109, file$1, 317, 3, 12789);
				add_location(br40, file$1, 326, 4, 12967);
				attr_dev(span4, "class", "cJQVer");
				attr_dev(span4, "v", "not");
				add_location(span4, file$1, 328, 4, 13068);
				attr_dev(div110, "class", "cPreDesc");
				add_location(div110, file$1, 325, 3, 12940);
				attr_dev(div111, "class", "cBack");
				add_location(div111, file$1, 332, 5, 13153);
				attr_dev(div112, "class", "cDesc");
				add_location(div112, file$1, 331, 4, 13128);
				add_location(div113, file$1, 330, 3, 13118);
				attr_dev(doc8, "name", "filter-not");
				add_location(doc8, file$1, 311, 2, 12527);
				attr_dev(h29, "class", "notranslate");
				add_location(h29, file$1, 340, 3, 13305);
				attr_dev(span5, "class", "cJQVer");
				attr_dev(span5, "v", "eq");
				add_location(span5, file$1, 343, 4, 13442);
				attr_dev(div114, "class", "cPreDesc");
				add_location(div114, file$1, 341, 3, 13340);
				attr_dev(div115, "class", "cBack");
				add_location(div115, file$1, 347, 5, 13526);
				attr_dev(div116, "class", "cDesc");
				add_location(div116, file$1, 346, 4, 13501);
				add_location(div117, file$1, 345, 3, 13491);
				add_location(br41, file$1, 354, 4, 13725);
				attr_dev(div118, "class", "cPreDesc");
				add_location(div118, file$1, 353, 3, 13698);
				attr_dev(div119, "class", "cBack");
				add_location(div119, file$1, 359, 5, 13868);
				attr_dev(div120, "class", "cDesc");
				add_location(div120, file$1, 358, 4, 13843);
				add_location(div121, file$1, 357, 3, 13833);
				attr_dev(doc9, "name", "eq");
				add_location(doc9, file$1, 339, 2, 13286);
				attr_dev(h210, "class", "notranslate");
				add_location(h210, file$1, 367, 3, 14121);
				attr_dev(span6, "class", "cJQVer");
				attr_dev(span6, "v", "first");
				add_location(span6, file$1, 370, 4, 14265);
				attr_dev(div122, "class", "cPreDesc");
				add_location(div122, file$1, 368, 3, 14166);
				attr_dev(div123, "class", "cBack");
				add_location(div123, file$1, 374, 5, 14352);
				attr_dev(div124, "class", "cDesc");
				add_location(div124, file$1, 373, 4, 14327);
				add_location(div125, file$1, 372, 3, 14317);
				add_location(br42, file$1, 381, 4, 14480);
				attr_dev(span7, "class", "cJQVer");
				attr_dev(span7, "v", "last");
				add_location(span7, file$1, 383, 4, 14559);
				attr_dev(div126, "class", "cPreDesc");
				add_location(div126, file$1, 380, 3, 14453);
				attr_dev(div127, "class", "cBack");
				add_location(div127, file$1, 387, 5, 14645);
				attr_dev(div128, "class", "cDesc");
				add_location(div128, file$1, 386, 4, 14620);
				add_location(div129, file$1, 385, 3, 14610);
				attr_dev(doc10, "name", "first-last");
				add_location(doc10, file$1, 366, 2, 14094);
				attr_dev(h211, "class", "notranslate");
				add_location(h211, file$1, 396, 3, 14775);
				attr_dev(span8, "class", "cJQVer");
				attr_dev(span8, "v", "has");
				add_location(span8, file$1, 399, 4, 14951);
				attr_dev(div130, "class", "cPreDesc");
				add_location(div130, file$1, 397, 3, 14811);
				attr_dev(div131, "class", "cBack");
				add_location(div131, file$1, 403, 5, 15036);
				attr_dev(div132, "class", "cDesc");
				add_location(div132, file$1, 402, 4, 15011);
				add_location(div133, file$1, 401, 3, 15001);
				attr_dev(doc11, "name", "has");
				add_location(doc11, file$1, 395, 2, 14755);
				attr_dev(h212, "class", "notranslate");
				add_location(h212, file$1, 412, 3, 15234);
				attr_dev(span9, "class", "cJQVer");
				attr_dev(span9, "v", "contains");
				add_location(span9, file$1, 415, 4, 15359);
				attr_dev(div134, "class", "cPreDesc");
				add_location(div134, file$1, 413, 3, 15275);
				attr_dev(div135, "class", "cBack");
				add_location(div135, file$1, 419, 5, 15449);
				attr_dev(div136, "class", "cDesc");
				add_location(div136, file$1, 418, 4, 15424);
				add_location(div137, file$1, 417, 3, 15414);
				attr_dev(doc12, "name", "contains");
				add_location(doc12, file$1, 411, 2, 15209);
				attr_dev(h213, "class", "notranslate");
				add_location(h213, file$1, 429, 3, 15588);
				attr_dev(span10, "class", "cJQVer");
				attr_dev(span10, "v", "slice");
				add_location(span10, file$1, 432, 4, 15737);
				attr_dev(div138, "class", "cPreDesc");
				add_location(div138, file$1, 430, 3, 15626);
				attr_dev(div139, "class", "cBack");
				add_location(div139, file$1, 436, 5, 15824);
				attr_dev(div140, "class", "cDesc");
				add_location(div140, file$1, 435, 4, 15799);
				add_location(div141, file$1, 434, 3, 15789);
				attr_dev(doc13, "name", "slice");
				add_location(doc13, file$1, 428, 2, 15566);
				attr_dev(h214, "class", "notranslate");
				add_location(h214, file$1, 446, 3, 15957);
				attr_dev(span11, "class", "cJQVer");
				attr_dev(span11, "v", "index");
				add_location(span11, file$1, 449, 4, 16086);
				attr_dev(div142, "class", "cPreDesc");
				add_location(div142, file$1, 447, 3, 15995);
				attr_dev(div143, "class", "cBack");
				add_location(div143, file$1, 453, 5, 16173);
				attr_dev(div144, "class", "cDesc");
				add_location(div144, file$1, 452, 4, 16148);
				add_location(div145, file$1, 451, 3, 16138);
				attr_dev(doc14, "name", "index");
				add_location(doc14, file$1, 445, 2, 15935);
				attr_dev(h215, "class", "notranslate");
				add_location(h215, file$1, 463, 3, 16303);
				attr_dev(span12, "class", "cJQVer");
				attr_dev(span12, "v", "is");
				add_location(span12, file$1, 466, 4, 16536);
				attr_dev(div146, "class", "cPreDesc");
				add_location(div146, file$1, 464, 3, 16338);
				attr_dev(div147, "class", "cBack");
				add_location(div147, file$1, 470, 5, 16620);
				attr_dev(div148, "class", "cDesc");
				add_location(div148, file$1, 469, 4, 16595);
				add_location(div149, file$1, 468, 3, 16585);
				attr_dev(doc15, "name", "is");
				add_location(doc15, file$1, 462, 2, 16284);
				attr_dev(h216, "class", "notranslate");
				add_location(h216, file$1, 480, 3, 16829);
				attr_dev(span13, "class", "cJQVer");
				attr_dev(span13, "v", "find");
				add_location(span13, file$1, 483, 4, 16974);
				attr_dev(div150, "class", "cPreDesc");
				add_location(div150, file$1, 481, 3, 16866);
				attr_dev(div151, "class", "cBack");
				add_location(div151, file$1, 487, 5, 17060);
				attr_dev(div152, "class", "cDesc");
				add_location(div152, file$1, 486, 4, 17035);
				add_location(div153, file$1, 485, 3, 17025);
				attr_dev(doc16, "name", "find");
				add_location(doc16, file$1, 479, 2, 16808);
				attr_dev(h217, "class", "notranslate");
				add_location(h217, file$1, 497, 3, 17194);
				attr_dev(span14, "class", "cJQVer");
				attr_dev(span14, "v", "children");
				add_location(span14, file$1, 500, 4, 17331);
				attr_dev(div154, "class", "cPreDesc");
				add_location(div154, file$1, 498, 3, 17235);
				attr_dev(div155, "class", "cBack");
				add_location(div155, file$1, 504, 5, 17421);
				attr_dev(div156, "class", "cDesc");
				add_location(div156, file$1, 503, 4, 17396);
				add_location(div157, file$1, 502, 3, 17386);
				attr_dev(doc17, "name", "children");
				add_location(doc17, file$1, 496, 2, 17169);
				attr_dev(h218, "class", "notranslate");
				add_location(h218, file$1, 514, 3, 17564);
				attr_dev(span15, "class", "cJQVer");
				attr_dev(span15, "v", "next");
				add_location(span15, file$1, 517, 4, 17731);
				attr_dev(div158, "class", "cPreDesc");
				add_location(div158, file$1, 515, 3, 17608);
				attr_dev(div159, "class", "cBack");
				add_location(div159, file$1, 521, 5, 17817);
				attr_dev(div160, "class", "cDesc");
				add_location(div160, file$1, 520, 4, 17792);
				add_location(div161, file$1, 519, 3, 17782);
				add_location(br43, file$1, 528, 4, 17943);
				attr_dev(span16, "class", "cJQVer");
				attr_dev(span16, "v", "prev");
				add_location(span16, file$1, 530, 4, 18047);
				attr_dev(div162, "class", "cPreDesc");
				add_location(div162, file$1, 527, 3, 17916);
				attr_dev(div163, "class", "cBack");
				add_location(div163, file$1, 534, 5, 18133);
				attr_dev(div164, "class", "cDesc");
				add_location(div164, file$1, 533, 4, 18108);
				add_location(div165, file$1, 532, 3, 18098);
				attr_dev(doc18, "name", "next-prev");
				add_location(doc18, file$1, 513, 2, 17538);
				attr_dev(h219, "class", "notranslate");
				add_location(h219, file$1, 544, 3, 18267);
				attr_dev(span17, "class", "cJQVer");
				attr_dev(span17, "v", "siblings");
				add_location(span17, file$1, 547, 4, 18403);
				attr_dev(div166, "class", "cPreDesc");
				add_location(div166, file$1, 545, 3, 18308);
				attr_dev(div167, "class", "cBack");
				add_location(div167, file$1, 551, 5, 18493);
				attr_dev(div168, "class", "cDesc");
				add_location(div168, file$1, 550, 4, 18468);
				add_location(div169, file$1, 549, 3, 18458);
				attr_dev(doc19, "name", "siblings");
				add_location(doc19, file$1, 543, 2, 18242);
				attr_dev(h220, "class", "notranslate");
				add_location(h220, file$1, 561, 3, 18641);
				attr_dev(span18, "class", "cJQVer");
				attr_dev(span18, "v", "parent");
				add_location(span18, file$1, 564, 4, 18799);
				attr_dev(div170, "class", "cPreDesc");
				add_location(div170, file$1, 562, 3, 18690);
				attr_dev(div171, "class", "cBack");
				add_location(div171, file$1, 568, 5, 18887);
				attr_dev(div172, "class", "cDesc");
				add_location(div172, file$1, 567, 4, 18862);
				add_location(div173, file$1, 566, 3, 18852);
				add_location(br44, file$1, 575, 4, 19017);
				attr_dev(span19, "class", "cJQVer");
				attr_dev(span19, "v", "parents");
				add_location(span19, file$1, 577, 4, 19112);
				attr_dev(div174, "class", "cPreDesc");
				add_location(div174, file$1, 574, 3, 18990);
				attr_dev(div175, "class", "cBack");
				add_location(div175, file$1, 581, 5, 19201);
				attr_dev(div176, "class", "cDesc");
				add_location(div176, file$1, 580, 4, 19176);
				add_location(div177, file$1, 579, 3, 19166);
				attr_dev(doc20, "name", "parent-parents");
				add_location(doc20, file$1, 560, 2, 18610);
				attr_dev(h221, "class", "notranslate");
				add_location(h221, file$1, 591, 3, 19340);
				attr_dev(span20, "class", "cJQVer");
				attr_dev(span20, "v", "closest");
				add_location(span20, file$1, 594, 4, 19575);
				attr_dev(div178, "class", "cPreDesc");
				add_location(div178, file$1, 592, 3, 19380);
				attr_dev(div179, "class", "cBack");
				add_location(div179, file$1, 598, 5, 19664);
				attr_dev(div180, "class", "cDesc");
				add_location(div180, file$1, 597, 4, 19639);
				add_location(div181, file$1, 596, 3, 19629);
				attr_dev(doc21, "name", "closest");
				add_location(doc21, file$1, 590, 2, 19316);
				attr_dev(h222, "class", "notranslate");
				add_location(h222, file$1, 608, 3, 19804);
				attr_dev(span21, "class", "cJQVer");
				attr_dev(span21, "v", "hasClass");
				add_location(span21, file$1, 611, 4, 19880);
				attr_dev(div182, "class", "cPreDesc");
				add_location(div182, file$1, 609, 3, 19845);
				attr_dev(div183, "class", "cBack");
				add_location(div183, file$1, 615, 5, 19970);
				attr_dev(div184, "class", "cDesc");
				add_location(div184, file$1, 614, 4, 19945);
				add_location(div185, file$1, 613, 3, 19935);
				attr_dev(doc22, "name", "hasClass");
				add_location(doc22, file$1, 607, 2, 19779);
				attr_dev(h223, "class", "notranslate");
				add_location(h223, file$1, 625, 3, 20108);
				attr_dev(span22, "class", "cJQVer");
				attr_dev(span22, "v", "isVisible");
				add_location(span22, file$1, 628, 4, 20185);
				attr_dev(div186, "class", "cPreDesc");
				add_location(div186, file$1, 626, 3, 20150);
				attr_dev(div187, "class", "cBack");
				add_location(div187, file$1, 632, 5, 20276);
				attr_dev(div188, "class", "cDesc");
				add_location(div188, file$1, 631, 4, 20251);
				add_location(div189, file$1, 630, 3, 20241);
				attr_dev(doc23, "name", "isVisible");
				add_location(doc23, file$1, 624, 2, 20082);
				attr_dev(h224, "class", "notranslate");
				add_location(h224, file$1, 642, 3, 20418);
				attr_dev(span23, "class", "cJQVer");
				attr_dev(span23, "v", "isPageLoaded");
				add_location(span23, file$1, 645, 4, 20498);
				attr_dev(div190, "class", "cPreDesc");
				add_location(div190, file$1, 643, 3, 20463);
				attr_dev(div191, "class", "cBack");
				add_location(div191, file$1, 649, 5, 20592);
				attr_dev(div192, "class", "cDesc");
				add_location(div192, file$1, 648, 4, 20567);
				add_location(div193, file$1, 647, 3, 20557);
				attr_dev(doc24, "name", "isPageLoaded");
				add_location(doc24, file$1, 641, 2, 20389);
				attr_dev(h225, "class", "notranslate");
				add_location(h225, file$1, 659, 3, 20729);
				attr_dev(span24, "class", "cJQVer");
				attr_dev(span24, "v", "html");
				add_location(span24, file$1, 662, 4, 20801);
				attr_dev(div194, "class", "cPreDesc");
				add_location(div194, file$1, 660, 3, 20766);
				attr_dev(div195, "class", "cBack");
				add_location(div195, file$1, 666, 5, 20887);
				attr_dev(div196, "class", "cDesc");
				add_location(div196, file$1, 665, 4, 20862);
				add_location(div197, file$1, 664, 3, 20852);
				attr_dev(doc25, "name", "html");
				add_location(doc25, file$1, 658, 2, 20708);
				attr_dev(h226, "class", "notranslate");
				add_location(h226, file$1, 676, 3, 21016);
				attr_dev(span25, "class", "cJQVer");
				attr_dev(span25, "v", "text");
				add_location(span25, file$1, 679, 4, 21088);
				attr_dev(div198, "class", "cPreDesc");
				add_location(div198, file$1, 677, 3, 21053);
				attr_dev(div199, "class", "cBack");
				add_location(div199, file$1, 683, 5, 21174);
				attr_dev(div200, "class", "cDesc");
				add_location(div200, file$1, 682, 4, 21149);
				add_location(div201, file$1, 681, 3, 21139);
				attr_dev(doc26, "name", "text");
				add_location(doc26, file$1, 675, 2, 20995);
				attr_dev(h227, "class", "notranslate");
				add_location(h227, file$1, 693, 3, 21302);
				attr_dev(span26, "class", "cJQVer");
				attr_dev(span26, "v", "val");
				add_location(span26, file$1, 696, 4, 21373);
				attr_dev(div202, "class", "cPreDesc");
				add_location(div202, file$1, 694, 3, 21338);
				attr_dev(div203, "class", "cBack");
				add_location(div203, file$1, 700, 5, 21458);
				attr_dev(div204, "class", "cDesc");
				add_location(div204, file$1, 699, 4, 21433);
				add_location(div205, file$1, 698, 3, 21423);
				attr_dev(doc27, "name", "val");
				add_location(doc27, file$1, 692, 2, 21282);
				attr_dev(h228, "class", "notranslate");
				add_location(h228, file$1, 710, 3, 21585);
				attr_dev(span27, "class", "cJQVer");
				attr_dev(span27, "v", "css");
				add_location(span27, file$1, 713, 4, 21656);
				attr_dev(div206, "class", "cPreDesc");
				add_location(div206, file$1, 711, 3, 21621);
				attr_dev(div207, "class", "cBack");
				add_location(div207, file$1, 717, 5, 21741);
				attr_dev(div208, "class", "cDesc");
				add_location(div208, file$1, 716, 4, 21716);
				add_location(div209, file$1, 715, 3, 21706);
				attr_dev(doc28, "name", "css");
				add_location(doc28, file$1, 709, 2, 21565);
				attr_dev(h229, "class", "notranslate");
				add_location(h229, file$1, 727, 3, 21869);
				attr_dev(span28, "class", "cJQVer");
				attr_dev(span28, "v", "attr");
				add_location(span28, file$1, 730, 4, 21941);
				attr_dev(div210, "class", "cPreDesc");
				add_location(div210, file$1, 728, 3, 21906);
				attr_dev(div211, "class", "cBack");
				add_location(div211, file$1, 734, 5, 22027);
				attr_dev(div212, "class", "cDesc");
				add_location(div212, file$1, 733, 4, 22002);
				add_location(div213, file$1, 732, 3, 21992);
				attr_dev(doc29, "name", "attr");
				add_location(doc29, file$1, 726, 2, 21848);
				attr_dev(h230, "class", "notranslate");
				add_location(h230, file$1, 744, 3, 22156);
				attr_dev(span29, "class", "cJQVer");
				attr_dev(span29, "v", "prop");
				add_location(span29, file$1, 747, 4, 22228);
				attr_dev(div214, "class", "cPreDesc");
				add_location(div214, file$1, 745, 3, 22193);
				attr_dev(div215, "class", "cBack");
				add_location(div215, file$1, 751, 5, 22314);
				attr_dev(div216, "class", "cDesc");
				add_location(div216, file$1, 750, 4, 22289);
				add_location(div217, file$1, 749, 3, 22279);
				attr_dev(doc30, "name", "prop");
				add_location(doc30, file$1, 743, 2, 22135);
				attr_dev(h231, "class", "notranslate");
				add_location(h231, file$1, 761, 3, 22442);
				attr_dev(span30, "class", "cJQVer");
				attr_dev(span30, "v", "get");
				add_location(span30, file$1, 764, 4, 22513);
				attr_dev(div218, "class", "cPreDesc");
				add_location(div218, file$1, 762, 3, 22478);
				attr_dev(div219, "class", "cBack");
				add_location(div219, file$1, 768, 5, 22598);
				attr_dev(div220, "class", "cDesc");
				add_location(div220, file$1, 767, 4, 22573);
				add_location(div221, file$1, 766, 3, 22563);
				attr_dev(doc31, "name", "get");
				add_location(doc31, file$1, 760, 2, 22422);
				attr_dev(h232, "class", "notranslate");
				add_location(h232, file$1, 778, 3, 22731);
				attr_dev(span31, "class", "cJQVer");
				attr_dev(span31, "v", "show-hide");
				add_location(span31, file$1, 781, 4, 22810);
				attr_dev(div222, "class", "cPreDesc");
				add_location(div222, file$1, 779, 3, 22775);
				attr_dev(div223, "class", "cBack");
				add_location(div223, file$1, 785, 5, 22901);
				attr_dev(div224, "class", "cDesc");
				add_location(div224, file$1, 784, 4, 22876);
				add_location(div225, file$1, 783, 3, 22866);
				attr_dev(doc32, "name", "show-hide");
				add_location(doc32, file$1, 777, 2, 22705);
				attr_dev(h233, "class", "notranslate");
				add_location(h233, file$1, 795, 3, 23037);
				attr_dev(span32, "class", "cJQVer");
				attr_dev(span32, "v", "remove");
				add_location(span32, file$1, 798, 4, 23111);
				attr_dev(div226, "class", "cPreDesc");
				add_location(div226, file$1, 796, 3, 23076);
				attr_dev(div227, "class", "cBack");
				add_location(div227, file$1, 802, 5, 23199);
				attr_dev(div228, "class", "cDesc");
				add_location(div228, file$1, 801, 4, 23174);
				add_location(div229, file$1, 800, 3, 23164);
				attr_dev(doc33, "name", "remove");
				add_location(doc33, file$1, 794, 2, 23014);
				attr_dev(h234, "class", "notranslate");
				add_location(h234, file$1, 812, 3, 23338);
				attr_dev(span33, "class", "cJQVer");
				attr_dev(span33, "v", "before-after");
				add_location(span33, file$1, 815, 4, 23420);
				attr_dev(div230, "class", "cPreDesc");
				add_location(div230, file$1, 813, 3, 23385);
				attr_dev(div231, "class", "cBack");
				add_location(div231, file$1, 819, 5, 23514);
				attr_dev(div232, "class", "cDesc");
				add_location(div232, file$1, 818, 4, 23489);
				add_location(div233, file$1, 817, 3, 23479);
				attr_dev(doc34, "name", "before-after");
				add_location(doc34, file$1, 811, 2, 23309);
				attr_dev(h235, "class", "notranslate");
				add_location(h235, file$1, 829, 3, 23661);
				attr_dev(span34, "class", "cJQVer");
				attr_dev(span34, "v", "prepend-append");
				add_location(span34, file$1, 832, 4, 23745);
				attr_dev(div234, "class", "cPreDesc");
				add_location(div234, file$1, 830, 3, 23710);
				attr_dev(div235, "class", "cBack");
				add_location(div235, file$1, 836, 5, 23841);
				attr_dev(div236, "class", "cDesc");
				add_location(div236, file$1, 835, 4, 23816);
				add_location(div237, file$1, 834, 3, 23806);
				attr_dev(doc35, "name", "prepend-append");
				add_location(doc35, file$1, 828, 2, 23630);
				attr_dev(h236, "class", "notranslate");
				add_location(h236, file$1, 846, 3, 23987);
				attr_dev(span35, "class", "cJQVer");
				attr_dev(span35, "v", "replaceWith");
				add_location(span35, file$1, 849, 4, 24066);
				attr_dev(div238, "class", "cPreDesc");
				add_location(div238, file$1, 847, 3, 24031);
				attr_dev(div239, "class", "cBack");
				add_location(div239, file$1, 853, 5, 24159);
				attr_dev(div240, "class", "cDesc");
				add_location(div240, file$1, 852, 4, 24134);
				add_location(div241, file$1, 851, 3, 24124);
				attr_dev(doc36, "name", "replaceWith");
				add_location(doc36, file$1, 845, 2, 23959);
				attr_dev(h237, "class", "notranslate");
				add_location(h237, file$1, 863, 3, 24311);
				attr_dev(span36, "class", "cJQVer");
				attr_dev(span36, "v", "addClass-removeClass");
				add_location(span36, file$1, 866, 4, 24401);
				attr_dev(div242, "class", "cPreDesc");
				add_location(div242, file$1, 864, 3, 24366);
				attr_dev(div243, "class", "cBack");
				add_location(div243, file$1, 870, 5, 24503);
				attr_dev(div244, "class", "cDesc");
				add_location(div244, file$1, 869, 4, 24478);
				add_location(div245, file$1, 868, 3, 24468);
				attr_dev(doc37, "name", "addClass-removeClass");
				add_location(doc37, file$1, 862, 2, 24274);
				attr_dev(h238, "class", "notranslate");
				add_location(h238, file$1, 880, 3, 24655);
				attr_dev(span37, "class", "cJQVer");
				attr_dev(span37, "v", "toggleClass");
				add_location(span37, file$1, 883, 4, 24734);
				attr_dev(div246, "class", "cPreDesc");
				add_location(div246, file$1, 881, 3, 24699);
				attr_dev(div247, "class", "cBack");
				add_location(div247, file$1, 887, 5, 24827);
				attr_dev(div248, "class", "cDesc");
				add_location(div248, file$1, 886, 4, 24802);
				add_location(div249, file$1, 885, 3, 24792);
				attr_dev(doc38, "name", "toggleClass");
				add_location(doc38, file$1, 879, 2, 24627);
				attr_dev(h239, "class", "notranslate");
				add_location(h239, file$1, 897, 3, 24971);
				attr_dev(span38, "class", "cJQVer");
				attr_dev(span38, "v", "width-height");
				add_location(span38, file$1, 900, 4, 25053);
				attr_dev(div250, "class", "cPreDesc");
				add_location(div250, file$1, 898, 3, 25018);
				attr_dev(div251, "class", "cBack");
				add_location(div251, file$1, 904, 5, 25147);
				attr_dev(div252, "class", "cDesc");
				add_location(div252, file$1, 903, 4, 25122);
				add_location(div253, file$1, 902, 3, 25112);
				attr_dev(doc39, "name", "width-height");
				add_location(doc39, file$1, 896, 2, 24942);
				attr_dev(h240, "class", "notranslate");
				add_location(h240, file$1, 914, 3, 25302);
				attr_dev(span39, "class", "cJQVer");
				attr_dev(span39, "v", "innerWidth-innerHeight");
				add_location(span39, file$1, 917, 4, 25394);
				attr_dev(div254, "class", "cPreDesc");
				add_location(div254, file$1, 915, 3, 25359);
				attr_dev(div255, "class", "cBack");
				add_location(div255, file$1, 921, 5, 25498);
				attr_dev(div256, "class", "cDesc");
				add_location(div256, file$1, 920, 4, 25473);
				add_location(div257, file$1, 919, 3, 25463);
				attr_dev(doc40, "name", "innerWidth-innerHeight");
				add_location(doc40, file$1, 913, 2, 25263);
				attr_dev(h241, "class", "notranslate");
				add_location(h241, file$1, 931, 3, 25663);
				attr_dev(span40, "class", "cJQVer");
				attr_dev(span40, "v", "outerWidth-outerHeight");
				add_location(span40, file$1, 934, 4, 25755);
				attr_dev(div258, "class", "cPreDesc");
				add_location(div258, file$1, 932, 3, 25720);
				attr_dev(div259, "class", "cBack");
				add_location(div259, file$1, 938, 5, 25859);
				attr_dev(div260, "class", "cDesc");
				add_location(div260, file$1, 937, 4, 25834);
				add_location(div261, file$1, 936, 3, 25824);
				attr_dev(doc41, "name", "outerWidth-outerHeight");
				add_location(doc41, file$1, 930, 2, 25624);
				attr_dev(h242, "class", "notranslate");
				add_location(h242, file$1, 948, 3, 26008);
				attr_dev(span41, "class", "cJQVer");
				attr_dev(span41, "v", "offset");
				add_location(span41, file$1, 951, 4, 26082);
				attr_dev(div262, "class", "cPreDesc");
				add_location(div262, file$1, 949, 3, 26047);
				attr_dev(div263, "class", "cBack");
				add_location(div263, file$1, 955, 5, 26170);
				attr_dev(div264, "class", "cDesc");
				add_location(div264, file$1, 954, 4, 26145);
				add_location(div265, file$1, 953, 3, 26135);
				attr_dev(doc42, "name", "offset");
				add_location(doc42, file$1, 947, 2, 25985);
				attr_dev(h243, "class", "notranslate");
				add_location(h243, file$1, 965, 3, 26309);
				attr_dev(span42, "class", "cJQVer");
				attr_dev(span42, "v", "pos-position");
				add_location(span42, file$1, 968, 4, 26391);
				attr_dev(div266, "class", "cPreDesc");
				add_location(div266, file$1, 966, 3, 26356);
				attr_dev(div267, "class", "cBack");
				add_location(div267, file$1, 972, 5, 26485);
				attr_dev(div268, "class", "cDesc");
				add_location(div268, file$1, 971, 4, 26460);
				add_location(div269, file$1, 970, 3, 26450);
				attr_dev(doc43, "name", "pos-position");
				add_location(doc43, file$1, 964, 2, 26280);
				attr_dev(h244, "class", "notranslate");
				add_location(h244, file$1, 982, 3, 26632);
				attr_dev(span43, "class", "cJQVer");
				attr_dev(span43, "v", "fadeIn-fadeOut");
				add_location(span43, file$1, 985, 4, 26716);
				attr_dev(div270, "class", "cPreDesc");
				add_location(div270, file$1, 983, 3, 26681);
				attr_dev(div271, "class", "cBack");
				add_location(div271, file$1, 989, 5, 26812);
				attr_dev(div272, "class", "cDesc");
				add_location(div272, file$1, 988, 4, 26787);
				add_location(div273, file$1, 987, 3, 26777);
				attr_dev(doc44, "name", "fadeIn-fadeOut");
				add_location(doc44, file$1, 981, 2, 26601);
				attr_dev(h245, "class", "notranslate");
				add_location(h245, file$1, 999, 3, 26954);
				attr_dev(span44, "class", "cJQVer");
				attr_dev(span44, "v", "animate");
				add_location(span44, file$1, 1002, 4, 27029);
				attr_dev(div274, "class", "cPreDesc");
				add_location(div274, file$1, 1000, 3, 26994);
				attr_dev(div275, "class", "cBack");
				add_location(div275, file$1, 1006, 5, 27118);
				attr_dev(div276, "class", "cDesc");
				add_location(div276, file$1, 1005, 4, 27093);
				add_location(div277, file$1, 1004, 3, 27083);
				attr_dev(doc45, "name", "animate");
				add_location(doc45, file$1, 998, 2, 26930);
				attr_dev(h246, "class", "notranslate");
				add_location(h246, file$1, 1016, 3, 27252);
				attr_dev(span45, "class", "cJQVer");
				attr_dev(span45, "v", "scroll");
				add_location(span45, file$1, 1019, 4, 27326);
				attr_dev(div278, "class", "cPreDesc");
				add_location(div278, file$1, 1017, 3, 27291);
				attr_dev(div279, "class", "cBack");
				add_location(div279, file$1, 1023, 5, 27414);
				attr_dev(div280, "class", "cDesc");
				add_location(div280, file$1, 1022, 4, 27389);
				add_location(div281, file$1, 1021, 3, 27379);
				attr_dev(doc46, "name", "scroll");
				add_location(doc46, file$1, 1015, 2, 27229);
				attr_dev(h247, "class", "notranslate");
				add_location(h247, file$1, 1033, 3, 27561);
				attr_dev(span46, "class", "cJQVer");
				attr_dev(span46, "v", "scrollTop-scrollLeft");
				add_location(span46, file$1, 1036, 4, 27651);
				attr_dev(div282, "class", "cPreDesc");
				add_location(div282, file$1, 1034, 3, 27616);
				attr_dev(div283, "class", "cBack");
				add_location(div283, file$1, 1040, 5, 27753);
				attr_dev(div284, "class", "cDesc");
				add_location(div284, file$1, 1039, 4, 27728);
				add_location(div285, file$1, 1038, 3, 27718);
				attr_dev(doc47, "name", "scrollTop-scrollLeft");
				add_location(doc47, file$1, 1032, 2, 27524);
				attr_dev(h248, "class", "notranslate");
				add_location(h248, file$1, 1050, 3, 27909);
				attr_dev(span47, "class", "cJQVer");
				attr_dev(span47, "v", "scrollToElement");
				add_location(span47, file$1, 1053, 4, 27992);
				attr_dev(div286, "class", "cPreDesc");
				add_location(div286, file$1, 1051, 3, 27957);
				attr_dev(div287, "class", "cBack");
				add_location(div287, file$1, 1057, 5, 28089);
				attr_dev(div288, "class", "cDesc");
				add_location(div288, file$1, 1056, 4, 28064);
				add_location(div289, file$1, 1055, 3, 28054);
				attr_dev(doc48, "name", "scrollToElement");
				add_location(doc48, file$1, 1049, 2, 27877);
				attr_dev(h249, "class", "notranslate");
				add_location(h249, file$1, 1067, 3, 28229);
				attr_dev(span48, "class", "cJQVer");
				attr_dev(span48, "v", "each");
				add_location(span48, file$1, 1070, 4, 28301);
				attr_dev(div290, "class", "cPreDesc");
				add_location(div290, file$1, 1068, 3, 28266);
				attr_dev(div291, "class", "cBack");
				add_location(div291, file$1, 1074, 5, 28387);
				attr_dev(div292, "class", "cDesc");
				add_location(div292, file$1, 1073, 4, 28362);
				add_location(div293, file$1, 1072, 3, 28352);
				attr_dev(doc49, "name", "each");
				add_location(doc49, file$1, 1066, 2, 28208);
				attr_dev(h250, "class", "notranslate");
				add_location(h250, file$1, 1084, 3, 28522);
				attr_dev(span49, "class", "cJQVer");
				attr_dev(span49, "v", "on-off-onf");
				add_location(span49, file$1, 1087, 4, 28604);
				attr_dev(div294, "class", "cPreDesc");
				add_location(div294, file$1, 1085, 3, 28569);
				attr_dev(div295, "class", "cBack");
				add_location(div295, file$1, 1091, 5, 28696);
				attr_dev(div296, "class", "cDesc");
				add_location(div296, file$1, 1090, 4, 28671);
				add_location(div297, file$1, 1089, 3, 28661);
				attr_dev(doc50, "name", "on-off-onf");
				add_location(doc50, file$1, 1083, 2, 28495);
				attr_dev(h251, "class", "notranslate");
				add_location(h251, file$1, 1101, 3, 28838);
				attr_dev(span50, "class", "cJQVer");
				attr_dev(span50, "v", "trg-trigger");
				add_location(span50, file$1, 1104, 4, 28919);
				attr_dev(div298, "class", "cPreDesc");
				add_location(div298, file$1, 1102, 3, 28884);
				attr_dev(div299, "class", "cBack");
				add_location(div299, file$1, 1108, 5, 29012);
				attr_dev(div300, "class", "cDesc");
				add_location(div300, file$1, 1107, 4, 28987);
				add_location(div301, file$1, 1106, 3, 28977);
				attr_dev(doc51, "name", "trg-trigger");
				add_location(doc51, file$1, 1100, 2, 28810);
				attr_dev(section4, "id", "idDoc");
